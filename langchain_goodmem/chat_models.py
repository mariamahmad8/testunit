...
class ChatGoodmem(BaseChatModel):
    ...
    """Goodmem chat model integration.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Goodmem API key. If not passed in will be read from env var GOODMEM_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatGoodmem.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatGoodmem.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatGoodmem supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatGoodmem supports async generation. Otherwise delete.
