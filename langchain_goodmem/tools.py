...
class GoodmemToolInput(BaseModel):
    """Input schema for Goodmem tool.
...
class GoodmemTool(BaseTool):  # type: ignore[override]
    """Goodmem tool.
    ...
    args_schema: Type[BaseModel] = GoodmemToolInput
