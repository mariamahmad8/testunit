...
class GoodmemLoader(BaseLoader):
    ...
    """
    Goodmem document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import GoodmemLoader

            loader = GoodmemLoader(
                # required params = ...
                # other params = ...
            )
